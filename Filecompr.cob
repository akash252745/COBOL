       ...
       PROGRAM-ID. FILECOMPR.

       ENVIRONMENT DIVISION.
       INPUT-OUTPUT SECTION.
       FILE-CONTROL.
           SELECT POLICY-IN1 ASSIGN TO 'File1.txt'
           ORGANIZATION IS SEQUENTIAL
           ACCESS MODE IS SEQUENTIAL
           FILE STATUS IS WS-FIL-ST1.

           SELECT POLICY-IN2 ASSIGN TO 'File2.txt'
           ORGANIZATION IS SEQUENTIAL
           ACCESS MODE IS SEQUENTIAL
           FILE STATUS IS WS-FIL-ST2.

           SELECT POLICY-OUT1 ASSIGN TO 'File3.txt'
           ORGANIZATION IS SEQUENTIAL
           ACCESS MODE IS SEQUENTIAL
           FILE STATUS IS WS-FIL-ST3.

           SELECT POLICY-OUT2 ASSIGN TO 'File4.txt'
           ORGANIZATION IS SEQUENTIAL
           ACCESS MODE IS SEQUENTIAL
           FILE STATUS IS WS-FIL-ST4.

           SELECT POLICY-OUT3 ASSIGN TO 'File5.txt'
           ORGANIZATION IS SEQUENTIAL
           ACCESS MODE IS SEQUENTIAL
       ...
       1000-INITIALIZE.
           ...
           MOVE ZEROES TO POLICY-NUMBERI2.
           MOVE ZEROES TO POLICY-NUMBERO1.
           MOVE ZEROES TO POLICY-NUMBERO2.
           MOVE ZEROES TO POLICY-NUMBERO3.
